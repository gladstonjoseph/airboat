...
station = ['A', 'B', 'C', 'D', 'E', 'F']
position = [2.230, 1.993, 1.874, 1.733, 1.599, 1.548]
top = [0.217, 0.181, 0.170, 0.159, 0.152, 0.150]
bottom = [0.188, 0.183, 0.181, 0.183, 0.188, 0.189]
...
canard_dim_df['Position'] = 2230 - canard_dim_df['Position']
...
plt.plot(canard_df['X'], canard_df['Y'], label='strake_1')
